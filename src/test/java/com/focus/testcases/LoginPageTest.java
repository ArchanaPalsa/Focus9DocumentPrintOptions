	...
	private static LoginPage lp;
	 ...
	 /* @Test(priority=3)
	  public void checkLoginPageAvailablityOfFields() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	  {
		  ...
		  lp=new LoginPage(getDriver());
		  Assert.assertEquals(LoginPage.checkLoginPageAvailablityOfFields(), true);
	  }
	  ...
	  {
		  lp=new LoginPage(getDriver());
		  Assert.assertEquals(LoginPage.checkCompanyTextDisplayInCompanyListDropdown(), true);  
	  }
	  ...
	  {
		  lp=new LoginPage(getDriver());
		  Assert.assertEquals(LoginPage.checkSignInBtnWithValidUserNameAndValidPassword(), true);
	  }
	  
	  
	  
	  @Test(priority=6)
	  public void checkUserNameInfoInHomePage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	  {
		  lp=new LoginPage(getDriver());
		  Assert.assertEquals(LoginPage.checkUserNameInfoInHomePage(), true);     
	  }
